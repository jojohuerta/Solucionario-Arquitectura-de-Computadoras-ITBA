...
.loop
    ...
    ;Also, since there only is in the stack the CALL of selection_sort and the RBP, RBX and RCX, 8 + 24 = 32
    ...
    MOV EBX, DWORD [RDI]                ;AUX1 = ARRAY[0]
    MOV ECX, DWORD [RDI + 4 * RAX]      ;AUX2 = ARRAY[MIN_INDEX]

    MOV [RDI + 4 * RAX], EBX            ;ARRAY[MIN_INDEX] = AUX1
    MOV [RDI], ECX                      ;ARRAY[0] = AUX2
